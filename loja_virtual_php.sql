...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Jan-2021 às 18:04
...
--
-- Banco de dados: `loja_virtual_php`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_admin.carrinho`
--

CREATE TABLE `tb_admin.carrinho` (
  `id` int(11) NOT NULL,
...
INSERT INTO `tb_admin.estoque` (`id`, `nome`, `descricao`, `altura`, `largura`, `comprimento`, `peso`, `quantidade`, `preco`, `categoria`, `destaque`) VALUES
(18, 'Óculos inteligente', 'Óculos inteligente', 15, 35, 25, 200, 9, '2000.00', 'acessorio', 'sim'),
(19, 'Tênis Ox', 'Tênis exportivo', 15, 10, 20, 200, 100, '200.00', 'tenis_masculina', 'sim'),
(20, 'Tênis ZX', 'Tênis ZX', 10, 10, 30, 360, 50, '150.00', 'tenis_feminino', 'nao'),
(34, 'Tênis yz', 'Tênis yz', 30, 30, 30, 30, 100, '500.00', 'tenis_masculina', 'sim'),
(35, 'Tênis aaa', 'Tênis aaa', 20, 20, 20, 20, 400, '120.00', 'tenis_feminino', 'sim');
...
(33, 18, '5f3c24a5c7c3a.jpg'),
(34, 19, '5f3edd68cd6cd.jpg'),
(35, 20, '5f3ede34d5231.jpg'),
(36, 34, '5f3ee5b39ac35.jpg'),
(37, 35, '5f3ee5f031076.jpg');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_admin.fornecedor`
--

CREATE TABLE `tb_admin.fornecedor` (
  `id` int(11) NOT NULL,
  `nome` varchar(255) NOT NULL,
...
--
-- Extraindo dados da tabela `tb_admin.fornecedor`
--

INSERT INTO `tb_admin.fornecedor` (`id`, `nome`, `telefone`, `produto`) VALUES
(1, 'Óculos TEC', '7522225555', '16'),
(2, 'Oculos ZZZ', '23 44447777', '16');
...
(1, 'admin', 'admin', '5efe25b33d50f.jpg', 'Cesar Henrique Ramos', 2),
...
--
-- Índices para tabela `tb_admin.carrinho`
--
ALTER TABLE `tb_admin.carrinho`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices para tabela `tb_admin.fornecedor`
--
ALTER TABLE `tb_admin.fornecedor`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `tb_admin.carrinho`
--
ALTER TABLE `tb_admin.carrinho`
...
--
-- AUTO_INCREMENT de tabela `tb_admin.fornecedor`
--
ALTER TABLE `tb_admin.fornecedor`
